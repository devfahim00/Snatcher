...
private const val releaseURL = "https://github.com/devfahim00/Snatcher/releases"
private const val repoUrl = "https://github.com/devfahim00/Snatcher"
private const val telegramChannelUrl = "https://t.me/projectredfox"
private const val TAG = "AboutPage"

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun AboutPage(onNavigateBack: () -> Unit, onNavigateToUpdatePage: () -> Unit) {
    val scrollBehavior =
...
fun AutoUpdateUnavailableDialog(onDismissRequest: () -> Unit = {}) {
    ...
    val annotatedString = buildAnnotatedString {
        ...
        addUrlAnnotation(
            UrlAnnotation("https://github.com/devfahim00/Snatcher/releases/latest"),
            start = startIndex,
            end = endIndex,
        )
        addStyle(
